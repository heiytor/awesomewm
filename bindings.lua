...
local terminals = {"alacritty", "kitty"} 
local TERMINAL = terminals[2]
...
M.global_keys = gears.table.join(
	...
	awful.key({ utils.MODKEY }, "f", function()
		awful.spawn(utils.AWESOME_DIR .. "/scripts/toggle-microphone")
	end, { description = "toggle microphone", group = "commansd" }),
